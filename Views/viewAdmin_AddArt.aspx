    ...
    <form runat="server">
        ...
        <%-- Agregar articulo --%>
            ...
            <div class="input-group">
                ...
                <asp:TextBox ID="txtDescripcion" runat="server"  class="form-control m-lg-1 rounded" Style="max-width:500px;" placeholder="Escriba la Descripcion del Articulo...">  </asp:TextBox>
            ...
            <div style="display: flex; margin-top: 1%; align-items: center;">
                ...
                <asp:TextBox ID="txtPrecio" runat="server" CssClass="form-control-sm"></asp:TextBox>
                <%--type="number"--%>
