                    ...
                    <div class="col-md-2 ">
                        <div class="cardUsuario shadow-lg">
                            ...
                            <div class="cardUsuario__wrapper">
                                ...
                                <asp:Button Text="Modificar" CssClass="cardUsuario__btn cardUsuario__btn-solid" runat="server" />
                                <asp:Button Text="Eliminar" CssClass="cardUsuario__btn cardUsuario__btn-solid" runat="server" />                      
                            </div>
                        </div>
                    </div>
                </ItemTemplate>
