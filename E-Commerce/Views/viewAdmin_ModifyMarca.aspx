    ...
    <form runat="server">
        ...
        <div class="container-fluid w-50 ">
            <div class="input-group mb-3 mt-3 ">
                ...
                <asp:TextBox ID="txtIDMarcaBuscado" runat="server" type="numeric" OnTextChanged="txtIDMarcaBuscado_TextChanged" AutoPostBack="true" CssClass="form-control m-lg-1 rounded">  </asp:TextBox>
